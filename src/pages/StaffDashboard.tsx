...
export default function StaffDashboard({ onNavigate }: StaffDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-gradient-to-r from-teal-600 to-teal-700 shadow-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>
              MEC Canteen - Staff Portal
            </h1>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-2 bg-white text-teal-700 px-4 py-2 rounded-lg hover:bg-teal-50 transition"
            >
              <Wallet size={20} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {menuItems.map((item) => (
                  <div key={item.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                    ...
                    <p className="text-lg font-bold text-teal-600 mb-3">₹{item.price.toFixed(2)}</p>
                    <button
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <button
                    onClick={placeOrder}
                    disabled={loading}
                    className="w-full bg-teal-600 text-white py-3 rounded-lg font-semibold hover:bg-teal-700 transition mt-4 disabled:opacity-50"
                  >
